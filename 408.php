        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12 d-flex align-items-center vh-100 error-wrapper">
            <div class="row">
              ...
              <div class="col-sm-12 col-md-12 col-lg-6">
                <h2 class="error-title">Request Times Out</h2>
                <p class="error-desc">You may have stopped your request prematurely before the server retrieved the information information.</p>
