        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12 d-flex align-items-center vh-100 error-wrapper">
            <div class="row">
              ...
              <div class="col-sm-12 col-md-12 col-lg-6">
                <h2 class="error-title">Oops! That is a bad request!.</h2>
                <p class="error-desc">Your request was incorrect. You could have typed a wrong URL or the particular page is not open to the public. Please check your URL carefully or, search the site to find the page you want.
                </p>
