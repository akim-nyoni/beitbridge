        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12 d-flex align-items-center vh-100 error-wrapper">
            <div class="row">
              ...
              <div class="col-sm-12 col-md-12 col-lg-6">
                <h2 class="error-title">Internal server error message!</h2>
                <p class="error-desc">There could be an internal problem with our web server, or the server is currently overloaded.</p>
